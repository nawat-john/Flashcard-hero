...
- [~] สร้างโปรเจกต์ Supabase (free tier) — _ผู้ใช้สร้างเอง แล้ววางคีย์ใน `.env`_
...
- [~] ทดสอบว่า user A แอบแก้ข้อมูล user B ไม่ได้ — _ทดสอบเองหลังตั้งค่า Supabase (policy เขียนไว้แล้ว)_
