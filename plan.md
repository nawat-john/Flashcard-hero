...
- [ ] (optional) offline support — sync กลับเมื่อมีเน็ต — _ข้ามไว้ก่อน (optional)_
...
- [ ] (optional) แชร์ทั้งโฟลเดอร์ (เผยแพร่ทั้ง subtree) — _ข้ามไว้ก่อน (optional)_
...
- [ ] กรณีโหลดทั้งโฟลเดอร์: copy ทั้ง subtree (folder + deck + card) — _ข้ามไว้ก่อน (optional, คู่กับการแชร์ทั้งโฟลเดอร์)_
- [x] progress การเรียนของ copy เริ่มใหม่ (ไม่ติดมาจากต้นฉบับ) — copy ได้ card id ใหม่ จึงไม่มี `card_reviews` ติดมา
- [~] ทดสอบ: เจ้าของแก้ต้นฉบับแล้ว copy ของคนอื่นต้องไม่เปลี่ยนตาม — _รอ deploy `phase3.sql` แล้วรัน verify (โค้ดเทสต์พร้อมแล้ว)_
